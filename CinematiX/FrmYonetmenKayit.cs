...
namespace CinematiX
{
    public partial class FrmYonetmenKayit : Form
    {
        ...
        private void eErkek_CheckedChanged(object sender, EventArgs e)
        {
            cinsiyet = "0";
        }
        ...
        private void btnkaydet_Click(object sender, EventArgs e)
        {
            ...
            if (txtAd.Text != "" && txtSoyad.Text != "" && txtbiyografi.Text != "" && resimyolu != "")
            {
                if (Convert.ToInt32(byas) >= 18) // Yaş kontrolü
                {
                    ...
                    connection.Open();
                    SqlCommand kayit = new SqlCommand("insert into Tbl_Yonetmenler (AdSoyad, Cinsiyet, Yaş, Biyografi, Resim) VALUES (@adsoyad, @cinsiyet,@yas, @biyografi, @resim)", connection);
                    ...
                    connection.Close();
                    MessageBox.Show("YONETMEN KAYIT İŞLEMİ BAŞARILI BİR ŞEKİLDE GERÇEKLEŞTİRİLDİ");
                    aractemizle();
                }
            }
